...
############################################################
#  Constant Keras gestion
############################################################
        """
class ConstantLayer(KL.Layer):
...
class MaskRCNN(object):
    ...
    def build(self, mode, config):
        ...
        if mode == "training":
            ...
            #const_lay = ConstantLayer(anchors)
            #anchors = const_lay(input_image)
            anchors = KL.Lambda(lambda x: K.constant(anchors), name="anchors")(input_image)
        else:
